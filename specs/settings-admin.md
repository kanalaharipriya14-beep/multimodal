...
- CLI helpers `scripts/antigravity-preset` and `scripts/antigravity-theme`.
...
`scripts/antigravity-preset` is a local CLI for preset store maintenance and backup of `presets.json`.
