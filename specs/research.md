...
- research CLI access in `scripts/antigravity-research`;
...
- Decide whether direct JSON access by `manage_research` and `scripts/antigravity-research` must be owner-filtered like browser routes or is local/tool-only.
