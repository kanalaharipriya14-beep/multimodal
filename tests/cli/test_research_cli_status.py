"""`antigravity-research list --status complete` must match completed runs.
...
def _load_cli():
    ...
    loader = importlib.machinery.SourceFileLoader("multivision_research_cli_status", str(path))
