"""`antigravity-research list --status complete` was returning nothing.
...
Part of #2122 (antigravity-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "antigravity-research"
    loader = importlib.machinery.SourceFileLoader("multivision_research_cli", str(path))
