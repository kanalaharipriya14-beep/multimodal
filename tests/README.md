...
```text
[order-report] working directory: /path/to/antigravity
...
[order-report] reproduce with: /path/to/antigravity/venv/bin/python /path/to/antigravity/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
