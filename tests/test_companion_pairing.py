...
@pytest.mark.parametrize(
    ("value", "expected"),
    [
        ("http://antigravity", ("antigravity", 80)),
        ("http://antigravity:7000", ("antigravity", 7000)),
        ("http://localhost:7000", ("localhost", 7000)),
        ("http://antigravity.local", ("antigravity.local", 80)),
        ("http://api.antigravity.local:7000", ("api.antigravity.local", 7000)),
...
@pytest.mark.parametrize(
    ...
    [
        "",
        "antigravity.example",
        "ftp://antigravity.example",
        "https://antigravity.local",
        "http://user:password@antigravity.local",
        "http://antigravity.local/",
        "http://antigravity.local/path",
        "http://antigravity.local?query=1",
        "http://antigravity.local#fragment",
        "http://antigravity.local:not-a-port",
        "http://antigravity.local:0",
        "http://antigravity.local:65536",
        "http://antigravity.local:07000",
        "HTTP://antigravity.local:7000",
        "http://Antigravity.local:7000",
        " http://antigravity.local",
        "http://antigravity.local ",
        "http://antigravity\\local",
        ...
        "http://antigravity%2elocal:7000",
        "http://%31%39%32.168.1.9:7000",
        "http://antigravity%40local:7000",
        "http://.local:7000",
        "http://antigravity..local:7000",
        "http://antigravity.local.:7000",
        "http://-antigravity:7000",
        "http://antigravity-:7000",
        "http://multivision_name:7000",
        f"http://{'a' * 64}:7000",
...
def test_pair_post_json_prefers_configured_origin(monkeypatch):
    monkeypatch.setenv("COMPANION_BASE_URL", "http://antigravity.local:7000")
    mint = MagicMock(return_value=("tok123", "ody_raw"))
    ...
    assert response["host"] == "antigravity.local"
    assert response["port"] == 7000
    assert response["hosts"] == ["antigravity.local"]
    assert set(response) == {
        "host",
        "port",
        "token",
...
def test_pair_post_rejects_invalid_config_before_mint_without_echoing_it(monkeypatch):
    ...
    monkeypatch.setenv(
        "COMPANION_BASE_URL",
        f"http://admin:{configured_secret}@antigravity.local",
    )
