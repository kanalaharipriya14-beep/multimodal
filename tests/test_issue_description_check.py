...
const context = {
  ...
  repo: { owner: 'antigravity-dev', repo: 'antigravity' },
};
const core = {
...
def test_bug_template_requires_exact_revision():
    ...
    assert revision["attributes"]["label"] == "Antigravity Revision"
...
def test_bug_checker_rejects_missing_or_malformed_revision(revision):
    ...
    assert "**Antigravity Revision**" in comment
