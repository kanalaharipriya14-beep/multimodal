"""cmd_add (scripts/antigravity-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "antigravity-memory"
    loader = importlib.machinery.SourceFileLoader("multivision_memory_cli_add", str(path))
