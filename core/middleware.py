...
INTERNAL_TOOL_TOKEN = os.environ.get("MULTIVISION_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Antigravity-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Antigravity-Internal-Token), or
