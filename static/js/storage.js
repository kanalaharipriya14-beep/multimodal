...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'antigravity-model-expanded',
  MODEL_ENDPOINTS: 'antigravity-model-endpoints',
  MODEL_SELECTED: 'antigravity-selected-model',
  SORT_ORDER: 'antigravity-sessions-sort',
  CHAT_SEARCH_SCOPE: 'antigravity-search-scope',
  INCOGNITO: 'antigravity-incognito',
  RAG_ACTIVE: 'antigravity-rag-active',
  MCP_ACTIVE: 'antigravity-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'antigravity-density',
  UI_SCALE: 'antigravity-ui-scale',
