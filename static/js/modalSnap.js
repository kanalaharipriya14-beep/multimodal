...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'antigravity-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'antigravity-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('antigravity:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
