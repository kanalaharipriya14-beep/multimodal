...
export const THEMES = {
  terracotta: { bg:'#F8F3EC', fg:'#2C1E18', panel:'#FFFFFF', border:'#E2D7C7', red:'#C56A3C',
                advanced: { sendBtnBg: '#C56A3C', sendBtnHover: '#B05A2E',
                            userBubbleBg: '#F3E9D8', aiBubbleBg: '#FFFFFF',
                            inputBg: '#FFFFFF', inputBorder: '#E2D7C7',
                            brandColor: '#C56A3C', brandMixTo: '#C56A3C' } },
  dark:       { bg:'#1E1916', fg:'#F3E9D8', panel:'#29221D', border:'#42362E', red:'#C56A3C',
                advanced: { sendBtnBg: '#C56A3C', sendBtnHover: '#B05A2E',
                            userBubbleBg: '#29221D', aiBubbleBg: '#1E1916',
                            inputBg: '#29221D', inputBorder: '#42362E',
                            brandColor: '#C56A3C', brandMixTo: '#C56A3C' } },
  light:      { bg:'#F8F3EC', fg:'#2C1E18', panel:'#FFFFFF', border:'#E2D7C7', red:'#C56A3C' },
  midnight:   { bg:'#0d1117', fg:'#c9d1d9', panel:'#161b22', border:'#30363d', red:'#f85149' },
  paper:      { bg:'#faf8f5', fg:'#3b3836', panel:'#ffffff', border:'#d5d0c8', red:'#C56A3C' },
...
const LS_KEY = 'multivision-theme';
const CUSTOM_THEMES_KEY = 'multivision-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Multivision Logo',    group: 'Sidebar' },
...
function _updateFavicon(fg) {
  ...
  if (routeShape) {
    ...
    svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path d='M16 4C9 4 4 11 4 16C4 21 9 28 16 28C23 28 28 21 28 16C28 11 23 4 16 4Z' fill='none' stroke='${fg}' stroke-width='2.2'/><path d='M2 16C2 16 8 8 16 8C24 8 30 16 30 16C30 16 24 24 16 24C8 24 2 16 2 16Z' fill='none' stroke='${fg}' stroke-width='2'/><circle cx='16' cy='16' r='4.5' fill='${fg}'/></svg>`;
  }
...
const UI_SCALE_KEY = 'multivision-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'multivision_' + (obj.name || 'theme') + '.json';
      a.click();
