...
<#
  Build a portable Windows distribution for Antigravity.

  Output layout:
    dist\Antigravity\Antigravity.exe
    dist\Antigravity\static\...
    dist\Antigravity\scripts\...
    dist\Antigravity\mcp_servers\...
    dist\Antigravity\services\hwfit\data\...
...
& $pyExe -m PyInstaller --noconfirm --clean --onedir --noconsole --icon=static/icon.ico --name Antigravity @dataArgs launcher.py
if ($LASTEXITCODE -ne 0) { Fail "PyInstaller build failed." }

Write-Host ""
Write-Host "Build complete." -ForegroundColor Green
Write-Host "Portable app folder: $PSScriptRoot\dist\Antigravity" -ForegroundColor Green
