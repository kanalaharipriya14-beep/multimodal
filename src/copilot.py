...
COPILOT_USER_AGENT = os.environ.get(
    "MULTIVISION_COPILOT_USER_AGENT", "Antigravity/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "MULTIVISION_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "MULTIVISION_COPILOT_EDITOR_VERSION", "Antigravity/1.0"
)
