...
class MemoryProvider(ABC):
    """Base contract for Antigravity memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for Antigravity' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "Antigravity native memory"
