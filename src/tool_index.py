...
COLLECTION_NAME = "multivision_tool_index"
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"research", "reserach", "reasearch", "look into", "investigate",
            ...
            {"trigger_research"},
        frozenset({"generate image", "create image", "draw image", "make image",
                   "generate an image", "create an image", "draw a", "make an image",
                   "image of", "picture of", "photo of", "generate photo",
                   "create picture", "draw photo", "illustration of"}):
            {"generate_image"},
