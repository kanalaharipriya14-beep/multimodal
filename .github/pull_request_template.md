...
- [ ] I searched [open issues](https://github.com/antigravity-dev/antigravity/issues) and [open PRs](https://github.com/antigravity-dev/antigravity/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Antigravity's existing visual language. Specifically:
