#!/usr/bin/env python3
"""Create/remove the switchable 'Demo' EmailAccount in Antigravity.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@antigravity.local mailbox. Password is stored Fernet-encrypted
...
NAME = "Demo"
IMAP_USER = "demo@antigravity.local"
