"""scripts/_lib/cli.py — shared scaffolding for the `antigravity-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("antigravity-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/antigravity-foo`
...
VERSION = "0.1.0"  # bumped centrally; every antigravity-* CLI reports this
