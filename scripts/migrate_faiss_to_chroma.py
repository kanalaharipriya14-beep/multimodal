...
Migrates:
  - Memory vectors: data/memory_vectors/ -> multivision_memories collection
  - RAG vectors:    data/rag/            -> multivision_rag collection
