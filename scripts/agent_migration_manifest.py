...
This helper is intentionally read-only. It does not import the Antigravity
application package, write to data/, call an LLM, or apply anything. It turns
common agent export shapes into a portable JSON manifest that Antigravity can
...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Build a neutral Antigravity agent migration manifest.")
