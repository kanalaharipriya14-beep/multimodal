...
Imports MemoryManager and MemoryVectorStore from the Antigravity codebase.
"""
...
_OWNER_ENV_KEYS = ("MULTIVISION_MCP_MEMORY_OWNER", "MULTIVISION_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set MULTIVISION_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
